...
const Sidebar = () => {
  ...
  return (
    ...
    <Spacer />
  <Box p='4'><details>
          <summary style={{listStyle:"none"}}> <Link to="/WomenData"  className='inner-slide-link-btn'>Women</Link></summary>
          <p>NEW</p>
          <p>PARTY</p>
          <p>BEST SELLERS</p>
          <p>BASICS</p>
  ...
  <Box p='4' >
   <details>
   <summary><Link to="/LinenPage"  className='inner-slide-link-btn'>MEN</Link></summary>
          <p>BLAZERS</p>
          <p>TOPS</p>
          <p>JEANS</p>
          <p>NEW</p>
  ...
  <Box p='4'>
    ...
    <details>
    <summary style={{listStyle:"none"}}>  <Link to="/KidsData" className='inner-slide-link-btn'>KID</Link></summary>
     <p>GIRL/BOY</p>
     <p>6 to 14 year</p>
     <p>BLAZERS</p>
          <p>TOPS</p>
  ...
  <Box p='4'>
    <details>
    <summary style={{listStyle:"none"}}> ZARAORIGINS</summary>
    <p>BLAZERS</p>
          <p>TOPS</p>
          <p>JEANS</p>
          <p>NEW</p>
